...
public class Fly {
    ...
    private static int fly(CommandSource source, ServerPlayerEntity player) {
        ...
        source.sendFeedback(new TranslationTextComponent("commands.fly.switched", player.getDisplayName(), new StringTextComponent(", LALALA"), new StringTextComponent("")), true);
        return 1;
    }
}
